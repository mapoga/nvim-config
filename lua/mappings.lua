...
-- Rez ------------------------------------------------------------------------
map({ "n", "t" }, "<leader>pb", require("configs.rez").build_cwd, { desc = "Package Build (rez)" })
map({ "n", "t" }, "<leader>px", require("configs.rez").clear_cwd_build, { desc = "Package Remove Build (rez)" })
